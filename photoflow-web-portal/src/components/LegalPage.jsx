  ...
  return (
    <div className="min-h-screen bg-ash-50 dark:bg-ash-950 transition-colors duration-tint font-sans">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-10 sm:px-8">
        ...
        <h1 className="mt-6 font-display text-4xl font-semibold tracking-tight text-ash-900 dark:text-white">
          {title}
        </h1>
...
function Section({ heading, children }) {
  return (
    <section className="mb-9">
      <h2 className="mb-3 font-display text-xl font-semibold tracking-tight text-ash-900 dark:text-white">
        {heading}
      </h2>
