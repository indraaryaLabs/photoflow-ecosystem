...
const Header = ({ project, themeChoice, cycleTheme }) => (
  <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-white/70 dark:bg-ash-950/70 border-b border-ash-200 dark:border-ash-800/50 transition-colors duration-300">
